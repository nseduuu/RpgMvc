    ...
    public class DisputasController : Controller
    {
        ...
        public async Task<ActionResult> IndexAsync()
        {
            try
            {
                ...
                //http://lzsouza.somee.com/RpgApi/Personagens/GetAll
        ...
        public async Task<ActionResult> IndexHabilidadesAsync()
        {
            try
            {
                ...
                if (response.StatusCode == System.Net.HttpStatusCode.OK)
                {
                    ...
                    //http://lzsouza.somee.com/RpgApi/PersonagemHabilidades/GetHabilidades

                string uriBuscaHbilidades = "http://lzsouza.somee.com/RpgApi/PersonagemHabilidades/GetHabilidades";
